...
// use Illuminate\Http\Request;
// use Illuminate\Support\Facades\Storage;
// use App\Notifications\AccountApproved; // Add this import
// use App\Notifications\AccountRejected;  // Add this import (new notification)
...
//         } catch (\Exception $e) {
//             \Log::error('Approval email failed for user ' . $user->email . ': ' . $e->getMessage());
//             // Continue even if email fails
//         }

//         return redirect()->route('admin.users.pending')->with('success', 'User approved successfully and notification sent!');
//     }
...
//         try {
//             // Create a simple rejection notification
//             $user->notify(new \App\Notifications\AccountRejected($request->rejection_reason));
//         } catch (\Exception $e) {
//             \Log::error('Rejection email failed for user ' . $user->email . ': ' . $e->getMessage());
//         }
